              ...
              <div ref={customPanelRef} className="mb-10 w-full select-none relative flex flex-col items-center">
                ...
                {showCustom && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 right-0 mt-2 rounded-xl z-30"
                    style={{
                    ...
                    <div className="px-5 sm:px-6 pt-5 pb-5" style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                            ...
                            return (
                              <motion.button
                                ...
                                style={{
                                  ...
                                  background: active ? 'rgba(0,255,65,0.1)' : 'transparent',
                                  textShadow: active ? '0 0 14px rgba(0,255,65,0.5)' : 'none',
                                ...
                                {active && (
                                  <motion.div
                                    ...
                                    style={{
                                      ...
                                      height: '1.5px', background: '#00FF41', borderRadius: '1px',
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        ...
                        <div className="hidden sm:flex items-center gap-1.5 font-mono" style={{ fontSize: '9px', color: 'rgba(0,204,53,0.18)', letterSpacing: '0.04em' }}>
                          ...
                          <span style={{ padding: '2px 6px', borderRadius: '4px', background: 'rgba(0,255,65,0.03)', border: '1px solid rgba(0,80,0,0.15)' }}>esc</span>
                          <span>restart</span>
                        </div>
                      </div>
